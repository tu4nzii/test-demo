"""Evaluation entry points for vertical bar charts."""
...
from prediction_core.evaluation_utils import numeric_mae, numeric_relative_error, save_axis_results
...
def save_results(records: list[dict[str, Any]], result_dir: Path) -> None:
    save_axis_results(
        ...
        plot_title="Y Axis MAE & Relative Error by Prompt+Image Setting",
        bar_color="#D98880",
        line_color="#5DADE2",
    )
