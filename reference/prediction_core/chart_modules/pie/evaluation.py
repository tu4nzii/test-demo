"""Evaluation entry points for pie charts."""

from __future__ import annotations

import pandas as pd

from reference.prediction_core.evaluation_utils import pie_angle_relative_error, polar_mae, save_polar_summary_and_plot
...
def compute_relative_error(pred: float | None, gt: float) -> float | None:
    return pie_angle_relative_error(pred, gt)
