"""Evaluation entry points for bubble charts."""
...
from reference.prediction_core.evaluation_utils import save_xy_results, xy_mae, xy_relative_error
...
def save_results(records: list[dict[str, Any]], result_dir: Path) -> None:
    save_xy_results(records, result_dir, chart_label="bubble")
