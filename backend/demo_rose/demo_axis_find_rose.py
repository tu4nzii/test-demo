...
class RoseChartAxisFinder:
    def __init__(self):
        ...
        # 缁熶竴杈撳嚭璺緞閰嶇疆
        self.output_dir = "./data/output/rose"  # 涓昏緭鍑虹洰褰?
    ...
    def process_single_image(self, image_path, center=None, radius=None, output_json_path=None):
        """Process one rose chart and recognize axes and labels."""
        try:
...
if __name__ == "__main__":
    ...
    # 鎸囧畾瑕佸鐞嗙殑鍥惧儚璺緞
    image_path = "./data/rose/rose_001.png"  # 鏍规嵁闇€瑕佷慨鏀?
