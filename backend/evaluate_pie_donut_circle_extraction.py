...
if str(BACKEND / "demo_pie") not in sys.path:
    sys.path.insert(0, str(BACKEND / "demo_pie"))
if str(BACKEND / "demo_donut") not in sys.path:
    sys.path.insert(0, str(BACKEND / "demo_donut"))

from demo_pie_circle_find_1 import PieCircleDetector  # noqa: E402
from demo_donut_circle_find_1 import DonutCircleDetector  # noqa: E402
...
OUTPUT_DIR = ROOT / "data" / "output" / "pie_donut_circle_eval"
