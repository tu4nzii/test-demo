...
from backend.polar.rose.detect_rose_axes import detect_rose
from backend.polar.radar.detect_radar_axes import evaluate, init_ocr

REAL_ROSE_DIR = (
    _project_root / "backend"
    / "real" / "RadarChart-18 & RoseChart-6" / "RoseChart-6"
)
SYNTH_ROSE_DIR = _project_root / "backend" / "real" / "rose"
