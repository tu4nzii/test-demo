...
Default:
  python backend/polar/scripts/select_axis_eval_samples.py --chart-type all --dataset synthetic --target 50 --no-llm
"""
...
from backend.polar.radar import evaluate_radar
from backend.polar.rose import evaluate_rose
from backend.polar.radar.detect_radar_axes import init_ocr


OUTPUT_DIR = POLAR_DATA / "output" / "axis_sample_selection"
