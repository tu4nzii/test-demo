...
class RadarChartAxisFinder:
    def __init__(self):
        ...
        # 统一输出路径配置
        self.output_dir = "./backend/data/polar/output/radar"  # 主输出目录
    ...
    def call_llm_letter(self, crop_img):
        ...
        try:
            content = chat_with_gemini_sync(payload["messages"], model=self.model_name, max_tokens=4096, temperature=0.5)
